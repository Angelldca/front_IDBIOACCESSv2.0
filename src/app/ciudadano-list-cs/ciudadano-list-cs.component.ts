...
@Component({
  ...
  providers: [],
  templateUrl: './ciudadano-list-cs.component.html',
  styleUrl: './ciudadano-list-cs.component.css'
})
export class CiudadanoListCSComponent {
  user = {
    entidad:"UCI"
  }

  urlList: string = urlBack + 'ciudadanocs/'
