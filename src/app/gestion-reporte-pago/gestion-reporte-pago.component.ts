...
import { TableReportePagoComponent } from '../table-reporte-pago/table-reporte-pago.component';
...
@Component({
  selector: 'app-gestion-reporte-pago',
  standalone: true,
  imports: [MatFormFieldModule, MatInputModule, 
    MatDatepickerModule,ReactiveFormsModule,
    MatButtonModule,
    TableReportePagoComponent,
    MatIconModule,
    FormsModule,
    HttpClientModule,
    TomarFotoComponent,
  ...
  templateUrl: './gestion-reporte-pago.component.html',
  styleUrl: './gestion-reporte-pago.component.css'
})
export class GestionReportePagoComponent {
  ...
  onSubmit(form: FormGroup){
   ...
   const data = {
    ...
    this.urlCiudadanos =
    `${urlBack}registropago/rango_fecha/?fecha_inicio=${data.fecha_inicio}&fecha_fin=${data.fecha_fin}`;
  ...
  donwloadListCiudadanos(form: FormGroup){
    ...
    const url = `${urlBack}registropago/exportar_csv/?fecha_inicio=${data.fecha_inicio}&fecha_fin=${data.fecha_fin}`
    ...
    this.httpClient.get(url, { responseType: 'blob',headers: headers })
        ...
        .subscribe((response: Blob) => {
            ...
            a.href = downloadUrl;
            a.download = `registropago_${data.fecha_inicio}_to_${data.fecha_fin}.csv`;
