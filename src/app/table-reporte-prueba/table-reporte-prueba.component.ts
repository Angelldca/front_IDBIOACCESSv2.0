...
@Component({
  selector: 'app-table-reporte-prueba',
  standalone: true,
  imports: [MatTableModule, MatPaginatorModule, MatTooltipModule,
    MatIconModule,MatButtonModule,
  ],
  providers:[SolapinService],
  templateUrl: './table-reporte-prueba.component.html',
  styleUrl: './table-reporte-prueba.component.css'
})


export class TableReportePruebaComponent implements AfterViewInit ,OnInit,OnChanges  {
  ...
  displayedColumns: string[] = ['id', 'numerosolapin', 'serial', 'codigobarra', 'idtiposolapin', 'nombrecompleto',
